            ...
            <li key={ele.id} style={{ marginLeft: '10px', width: '420px' }}>
              <Card sx={{ width: isMobileView ? "330px" : "400px", backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                  <Typography sx={{fontSize:'17px', fontWeight: '600', color: '#333', fontFamily: 'lato', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', width: '100%', marginTop: '10px' }} variant="h5">
                    {ele.title} <span style={{ fontSize: '15px',border:'2px solid red',borderRadius:'10px',padding:'2px', fontWeight: '400', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>  <LocationOnIcon sx={{ fontSize: '15px', color: 'green' }} /> {ele.location}</span>
                  </Typography>
